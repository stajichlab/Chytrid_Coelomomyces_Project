...
busco -i $INDIR/Allma1_AssemblyScaffolds_Repeatmasked.fasta -l $BUSCO_SET -o busco_fungi_Allma1 -m genome --cpu 12 

busco -i $INDIR/Catan2_AssemblyScaffolds_Repeatmasked.fasta -l $BUSCO_SET -o busco_fungi_Catan2 -m genome --cpu 12 

busco -i $INDIR/Blabri1_AssemblyScaffolds_Repeatmasked.fasta -l $BUSCO_SET -o busco_fungi_Blabri1 -m genome --cpu 12 

busco -i $INDIR/Parsed1_AssemblyScaffolds_Repeatmasked.fasta -l $BUSCO_SET -o busco_fungi_Parsed1 -m genome --cpu 12 
